 ...
 * <!-- end-user-doc -->
 * @see processModel.ProcessModelPackage
 * @generated
 */
public class ProcessModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProcessModelSwitch<Adapter> modelSwitch =
		new ProcessModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseProcess(processModel.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link processModel.Task <em>Task</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link processModel.Activity <em>Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link processModel.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
