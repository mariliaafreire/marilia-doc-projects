...
public class ExperimentalPlanImpl extends EObjectImpl implements ExperimentalPlan {
	 ...
	 * @ordered
	 */
	protected EList<Hyphoteses> hypothesis;
	 ...
	 * @generated
	 */
	public EList<Hyphoteses> getHypothesis() {
		if (hypothesis == null) {
			hypothesis = new EObjectContainmentEList<Hyphoteses>(Hyphoteses.class, this, Jpdl31Package.EXPERIMENTAL_PLAN__HYPOTHESIS);
		}
		return hypothesis;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Jpdl31Package.EXPERIMENTAL_PLAN__HYPOTHESIS:
				getHypothesis().clear();
				getHypothesis().addAll((Collection<? extends Hyphoteses>)newValue);
				return;
			case Jpdl31Package.EXPERIMENTAL_PLAN__DESIGN:
