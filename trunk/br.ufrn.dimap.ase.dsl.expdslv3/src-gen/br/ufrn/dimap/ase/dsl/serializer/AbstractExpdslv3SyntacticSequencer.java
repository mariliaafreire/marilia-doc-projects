...
public class AbstractExpdslv3SyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ExperimentalDesign_ContextKeyword_10_0_q;
	protected AbstractElementAlias match_ExperimentalDesign_KeywordsKeyword_2_0_q;
	protected AbstractElementAlias match_ExperimentalDesign___AutorshipKeyword_0_0_LeftCurlyBracketKeyword_0_1_RightCurlyBracketKeyword_0_3__q;
	...
	protected AbstractElementAlias match_Factor___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q;
	protected AbstractElementAlias match_Process_RoleKeyword_2_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ExperimentalDesign_ContextKeyword_10_0_q = new TokenAlias(true, false, grammarAccess.getExperimentalDesignAccess().getContextKeyword_10_0());
		match_ExperimentalDesign_KeywordsKeyword_2_0_q = new TokenAlias(true, false, grammarAccess.getExperimentalDesignAccess().getKeywordsKeyword_2_0());
		match_ExperimentalDesign___AutorshipKeyword_0_0_LeftCurlyBracketKeyword_0_1_RightCurlyBracketKeyword_0_3__q = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getExperimentalDesignAccess().getAutorshipKeyword_0_0()), new TokenAlias(false, false, grammarAccess.getExperimentalDesignAccess().getLeftCurlyBracketKeyword_0_1()), new TokenAlias(false, false, grammarAccess.getExperimentalDesignAccess().getRightCurlyBracketKeyword_0_3()));
		...
		match_Factor___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getFactorAccess().getLeftParenthesisKeyword_1_0()), new TokenAlias(false, false, grammarAccess.getFactorAccess().getRightParenthesisKeyword_1_2()));
		match_Process_RoleKeyword_2_0_q = new TokenAlias(true, false, grammarAccess.getProcessAccess().getRoleKeyword_2_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_ExperimentalDesign_ContextKeyword_10_0_q.equals(syntax))
				emit_ExperimentalDesign_ContextKeyword_10_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_ExperimentalDesign_KeywordsKeyword_2_0_q.equals(syntax))
				emit_ExperimentalDesign_KeywordsKeyword_2_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_ExperimentalDesign___AutorshipKeyword_0_0_LeftCurlyBracketKeyword_0_1_RightCurlyBracketKeyword_0_3__q.equals(syntax))
				emit_ExperimentalDesign___AutorshipKeyword_0_0_LeftCurlyBracketKeyword_0_1_RightCurlyBracketKeyword_0_3__q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_Factor___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q.equals(syntax))
				emit_Factor___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Process_RoleKeyword_2_0_q.equals(syntax))
				emit_Process_RoleKeyword_2_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     'Context'?
	 */
	protected void emit_ExperimentalDesign_ContextKeyword_10_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     'Keywords'?
	 */
	protected void emit_ExperimentalDesign_KeywordsKeyword_2_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     ('Autorship' '{' '}')?
	 */
	protected void emit_ExperimentalDesign___AutorshipKeyword_0_0_LeftCurlyBracketKeyword_0_1_RightCurlyBracketKeyword_0_3__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     ('(' ')')?
	 */
	protected void emit_Factor___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     'Role'?
	 */
	protected void emit_Process_RoleKeyword_2_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
