...
public class UmaSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UmaPackage.PACKAGE: {
				uma.Package package_ = (uma.Package)theEObject;
			...
			case UmaPackage.KIND: {
				...
				if (result == null) result = caseVariabilityElement(kind);
			...
			case UmaPackage.CONTENT_ELEMENT: {
				...
				if (result == null) result = caseVariabilityElement(contentElement);
				if (result == null) result = caseMethodElement(contentElement);
				if (result == null) result = caseClassifier(contentElement);
				if (result == null) result = caseType(contentElement);
			...
			case UmaPackage.DESCRIBABLE_ELEMENT: {
				...
				if (result == null) result = caseClassifier(describableElement);
				if (result == null) result = caseType(describableElement);
			...
			case UmaPackage.SUPPORTING_MATERIAL: {
				...
				if (result == null) result = caseClassifier(supportingMaterial);
				if (result == null) result = caseType(supportingMaterial);
			...
			case UmaPackage.GUIDANCE: {
				...
				if (result == null) result = caseClassifier(guidance);
				if (result == null) result = caseType(guidance);
			...
			case UmaPackage.SECTION: {
				...
				if (result == null) result = caseVariabilityElement(section);
			...
			case UmaPackage.VARIABILITY_ELEMENT: {
				...
				if (result == null) result = caseMethodElement(variabilityElement);
				if (result == null) result = casePackageableElement(variabilityElement);
				if (result == null) result = caseNamedElement(variabilityElement);
				if (result == null) result = caseElement(variabilityElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case UmaPackage.CHECKLIST: {
				...
				if (result == null) result = caseClassifier(checklist);
				if (result == null) result = caseType(checklist);
			...
			case UmaPackage.GUIDELINE: {
				...
				if (result == null) result = caseClassifier(guideline);
				if (result == null) result = caseType(guideline);
			...
			case UmaPackage.EXAMPLE: {
				...
				if (result == null) result = caseClassifier(example);
				if (result == null) result = caseType(example);
			...
			case UmaPackage.REUSABLE_ASSET: {
				...
				if (result == null) result = caseClassifier(reusableAsset);
				if (result == null) result = caseType(reusableAsset);
			...
			case UmaPackage.TERM_DEFINITION: {
				...
				if (result == null) result = caseClassifier(termDefinition);
				if (result == null) result = caseType(termDefinition);
			...
			case UmaPackage.APPLICABLE_META_CLASS_INFO: {
				...
				if (result == null) result = caseClassifier(applicableMetaClassInfo);
				if (result == null) result = caseType(applicableMetaClassInfo);
			...
			case UmaPackage.ARTIFACT: {
				...
				if (result == null) result = caseFulfillableElement(artifact);
			...
			case UmaPackage.WORK_PRODUCT: {
				...
				if (result == null) result = caseFulfillableElement(workProduct);
				if (result == null) result = caseDescribableElement(workProduct);
				if (result == null) result = caseVariabilityElement(workProduct);
				if (result == null) result = caseMethodElement(workProduct);
				if (result == null) result = caseClassifier(workProduct);
				if (result == null) result = caseType(workProduct);
			...
			case UmaPackage.FULFILLABLE_ELEMENT: {
				...
				if (result == null) result = caseDescribableElement(fulfillableElement);
				if (result == null) result = caseMethodElement(fulfillableElement);
				if (result == null) result = caseClassifier(fulfillableElement);
				if (result == null) result = caseType(fulfillableElement);
				if (result == null) result = casePackageableElement(fulfillableElement);
				if (result == null) result = caseNamedElement(fulfillableElement);
				if (result == null) result = caseElement(fulfillableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.REPORT: {
				...
				if (result == null) result = caseType(report);
			...
			case UmaPackage.TOOL_MENTOR: {
				...
				if (result == null) result = caseClassifier(toolMentor);
				if (result == null) result = caseType(toolMentor);
			...
			case UmaPackage.ESTIMATION_CONSIDERATIONS: {
				...
				if (result == null) result = caseVariabilityElement(estimationConsiderations);
				if (result == null) result = caseMethodElement(estimationConsiderations);
				if (result == null) result = caseClassifier(estimationConsiderations);
				if (result == null) result = caseType(estimationConsiderations);
			...
			case UmaPackage.DELIVERABLE: {
				...
				if (result == null) result = caseFulfillableElement(deliverable);
				if (result == null) result = caseDescribableElement(deliverable);
				if (result == null) result = caseVariabilityElement(deliverable);
				if (result == null) result = caseMethodElement(deliverable);
				if (result == null) result = caseClassifier(deliverable);
				if (result == null) result = caseType(deliverable);
			...
			case UmaPackage.OUTCOME: {
				...
				if (result == null) result = caseFulfillableElement(outcome);
				if (result == null) result = caseDescribableElement(outcome);
				if (result == null) result = caseVariabilityElement(outcome);
				if (result == null) result = caseMethodElement(outcome);
				if (result == null) result = caseClassifier(outcome);
			...
			case UmaPackage.STEP: {
				...
				if (result == null) result = caseSection(step);
				if (result == null) result = caseWorkDefinition(step);
				if (result == null) result = caseVariabilityElement(step);
				if (result == null) result = caseMethodElement(step);
				if (result == null) result = casePackageableElement(step);
			...
			case UmaPackage.WHITEPAPER: {
				...
				if (result == null) result = caseClassifier(whitepaper);
				if (result == null) result = caseType(whitepaper);
			...
			case UmaPackage.TASK: {
				...
				if (result == null) result = caseWorkDefinition(task);
				if (result == null) result = caseDescribableElement(task);
				if (result == null) result = caseVariabilityElement(task);
				if (result == null) result = caseMethodElement(task);
				if (result == null) result = caseClassifier(task);
			...
			case UmaPackage.ROLE: {
				...
				if (result == null) result = caseFulfillableElement(role);
				if (result == null) result = caseDescribableElement(role);
				if (result == null) result = caseVariabilityElement(role);
			...
			case UmaPackage.ROLE_SET: {
				...
				if (result == null) result = caseClassifier(roleSet);
				if (result == null) result = caseType(roleSet);
			...
			case UmaPackage.CONTENT_CATEGORY: {
				...
				if (result == null) result = caseVariabilityElement(contentCategory);
				if (result == null) result = caseMethodElement(contentCategory);
				if (result == null) result = caseClassifier(contentCategory);
				if (result == null) result = caseType(contentCategory);
			...
			case UmaPackage.WORK_PRODUCT_TYPE: {
				...
				if (result == null) result = caseVariabilityElement(workProductType);
				if (result == null) result = caseMethodElement(workProductType);
				if (result == null) result = caseClassifier(workProductType);
				if (result == null) result = caseType(workProductType);
			...
			case UmaPackage.DISCIPLINE_GROUPING: {
				...
				if (result == null) result = caseClassifier(disciplineGrouping);
				if (result == null) result = caseType(disciplineGrouping);
			...
			case UmaPackage.DISCIPLINE: {
				...
				if (result == null) result = caseClassifier(discipline);
				if (result == null) result = caseType(discipline);
			...
			case UmaPackage.ACTIVITY: {
				...
				if (result == null) result = caseFulfillableElement(activity);
			...
			case UmaPackage.WORK_BREAKDOWN_ELEMENT: {
				...
				if (result == null) result = caseClassifier(workBreakdownElement);
				if (result == null) result = caseType(workBreakdownElement);
			...
			case UmaPackage.BREAKDOWN_ELEMENT: {
				...
				if (result == null) result = caseClassifier(breakdownElement);
				if (result == null) result = caseType(breakdownElement);
			...
			case UmaPackage.PROCESS_ELEMENT: {
				...
				if (result == null) result = caseClassifier(processElement);
				if (result == null) result = caseType(processElement);
			...
			case UmaPackage.PLANNING_DATA: {
				...
				if (result == null) result = caseClassifier(planningData);
				if (result == null) result = caseType(planningData);
			...
			case UmaPackage.WORK_ORDER: {
				...
				if (result == null) result = caseProcessElement(workOrder);
				if (result == null) result = caseDescribableElement(workOrder);
				if (result == null) result = caseMethodElement(workOrder);
				if (result == null) result = caseClassifier(workOrder);
				if (result == null) result = caseType(workOrder);
				if (result == null) result = casePackageableElement(workOrder);
				if (result == null) result = caseNamedElement(workOrder);
				if (result == null) result = caseElement(workOrder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.ROADMAP: {
				...
				if (result == null) result = caseClassifier(roadmap);
				if (result == null) result = caseType(roadmap);
			...
			case UmaPackage.TOOL: {
				...
				if (result == null) result = caseVariabilityElement(tool);
			...
			case UmaPackage.ROLE_SET_GROUPING: {
				...
				if (result == null) result = caseVariabilityElement(roleSetGrouping);
				if (result == null) result = caseMethodElement(roleSetGrouping);
				if (result == null) result = caseClassifier(roleSetGrouping);
				if (result == null) result = caseType(roleSetGrouping);
			...
			case UmaPackage.CUSTOM_CATEGORY: {
				...
				if (result == null) result = caseClassifier(customCategory);
				if (result == null) result = caseType(customCategory);
			...
			case UmaPackage.METHOD_PACKAGE: {
				...
				if (result == null) result = casePackage(methodPackage);
				if (result == null) result = casePackageableElement(methodPackage);
				if (result == null) result = caseNamespace(methodPackage);
			...
			case UmaPackage.CONTENT_PACKAGE: {
				...
				if (result == null) result = casePackage(contentPackage);
				if (result == null) result = casePackageableElement(contentPackage);
				if (result == null) result = caseNamespace(contentPackage);
			...
			case UmaPackage.MILESTONE: {
				...
				if (result == null) result = caseClassifier(milestone);
				if (result == null) result = caseType(milestone);
			...
			case UmaPackage.WORK_PRODUCT_DESCRIPTOR: {
				...
				if (result == null) result = caseClassifier(workProductDescriptor);
				if (result == null) result = caseType(workProductDescriptor);
			...
			case UmaPackage.DESCRIPTOR: {
				...
				if (result == null) result = caseClassifier(descriptor);
				if (result == null) result = caseType(descriptor);
			...
			case UmaPackage.ITERATION: {
				...
				if (result == null) result = caseFulfillableElement(iteration);
				...
				if (result == null) result = caseClassifier(iteration);
				if (result == null) result = caseType(iteration);
			...
			case UmaPackage.PHASE: {
				...
				if (result == null) result = caseFulfillableElement(phase);
			...
			case UmaPackage.TEAM_PROFILE: {
				...
				if (result == null) result = caseClassifier(teamProfile);
				if (result == null) result = caseType(teamProfile);
			...
			case UmaPackage.ROLE_DESCRIPTOR: {
				...
				if (result == null) result = caseClassifier(roleDescriptor);
				if (result == null) result = caseType(roleDescriptor);
			...
			case UmaPackage.TASK_DESCRIPTOR: {
				...
				if (result == null) result = caseClassifier(taskDescriptor);
				if (result == null) result = caseType(taskDescriptor);
			...
			case UmaPackage.COMPOSITE_ROLE: {
				...
				if (result == null) result = caseClassifier(compositeRole);
				if (result == null) result = caseType(compositeRole);
			...
			case UmaPackage.DELIVERY_PROCESS: {
				...
				if (result == null) result = caseFulfillableElement(deliveryProcess);
				...
				if (result == null) result = caseClassifier(deliveryProcess);
				if (result == null) result = caseType(deliveryProcess);
			...
			case UmaPackage.PROCESS: {
				...
				if (result == null) result = caseType(process);
			...
			case UmaPackage.CAPABILITY_PATTERN: {
				...
				if (result == null) result = caseFulfillableElement(capabilityPattern);
				...
				if (result == null) result = caseClassifier(capabilityPattern);
				if (result == null) result = caseType(capabilityPattern);
			...
			case UmaPackage.METHOD_PLUGIN: {
				...
				if (result == null) result = casePackage(methodPlugin);
				if (result == null) result = caseMethodElement(methodPlugin);
				if (result == null) result = caseNamespace(methodPlugin);
			...
			case UmaPackage.PROCESS_PLANNING_TEMPLATE: {
				...
				if (result == null) result = caseFulfillableElement(processPlanningTemplate);
				...
				if (result == null) result = caseClassifier(processPlanningTemplate);
				if (result == null) result = caseType(processPlanningTemplate);
			...
			case UmaPackage.PRACTICE: {
				...
				if (result == null) result = caseClassifier(practice);
				if (result == null) result = caseType(practice);
			...
			case UmaPackage.PROCESS_COMPONENT_DESCRIPTOR: {
				...
				if (result == null) result = caseDescriptor(processComponentDescriptor);
				if (result == null) result = caseBreakdownElement(processComponentDescriptor);
				if (result == null) result = caseProcessElement(processComponentDescriptor);
				if (result == null) result = caseDescribableElement(processComponentDescriptor);
				if (result == null) result = caseMethodElement(processComponentDescriptor);
				if (result == null) result = caseClassifier(processComponentDescriptor);
				if (result == null) result = caseType(processComponentDescriptor);
				if (result == null) result = casePackageableElement(processComponentDescriptor);
				if (result == null) result = caseNamedElement(processComponentDescriptor);
				if (result == null) result = caseElement(processComponentDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case UmaPackage.DIAGRAM: {
				...
				if (result == null) result = caseMethodElement(diagram);
				if (result == null) result = casePackageableElement(diagram);
			...
			case UmaPackage.GRAPH_NODE: {
				...
				if (result == null) result = caseMethodElement(graphNode);
				if (result == null) result = casePackageableElement(graphNode);
				if (result == null) result = caseNamedElement(graphNode);
				if (result == null) result = caseElement(graphNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.GRAPH_ELEMENT: {
				...
				if (result == null) result = caseMethodElement(graphElement);
				if (result == null) result = casePackageableElement(graphElement);
				if (result == null) result = caseNamedElement(graphElement);
				if (result == null) result = caseElement(graphElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.DIAGRAM_ELEMENT: {
				...
				if (result == null) result = caseMethodElement(diagramElement);
				if (result == null) result = casePackageableElement(diagramElement);
				if (result == null) result = caseNamedElement(diagramElement);
				if (result == null) result = caseElement(diagramElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.REFERENCE: {
				...
				if (result == null) result = caseMethodElement(reference);
				if (result == null) result = casePackageableElement(reference);
			...
			case UmaPackage.PROPERTY: {
				...
				if (result == null) result = caseDiagramElement(property);
				if (result == null) result = caseMethodElement(property);
			...
			case UmaPackage.DIAGRAM_LINK: {
				...
				if (result == null) result = caseDiagramElement(diagramLink);
				if (result == null) result = caseMethodElement(diagramLink);
				if (result == null) result = casePackageableElement(diagramLink);
				if (result == null) result = caseNamedElement(diagramLink);
				if (result == null) result = caseElement(diagramLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.GRAPH_CONNECTOR: {
				...
				if (result == null) result = caseGraphElement(graphConnector);
				if (result == null) result = caseDiagramElement(graphConnector);
				if (result == null) result = caseMethodElement(graphConnector);
				if (result == null) result = casePackageableElement(graphConnector);
				if (result == null) result = caseNamedElement(graphConnector);
				if (result == null) result = caseElement(graphConnector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.GRAPH_EDGE: {
				...
				if (result == null) result = caseMethodElement(graphEdge);
				if (result == null) result = casePackageableElement(graphEdge);
				if (result == null) result = caseNamedElement(graphEdge);
				if (result == null) result = caseElement(graphEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.SEMANTIC_MODEL_BRIDGE: {
				...
				if (result == null) result = caseDiagramElement(semanticModelBridge);
				if (result == null) result = caseMethodElement(semanticModelBridge);
				if (result == null) result = casePackageableElement(semanticModelBridge);
				if (result == null) result = caseNamedElement(semanticModelBridge);
				if (result == null) result = caseElement(semanticModelBridge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case UmaPackage.PROCESS_COMPONENT_INTERFACE: {
				...
				if (result == null) result = caseClassifier(processComponentInterface);
				if (result == null) result = caseType(processComponentInterface);
			...
			case UmaPackage.SIMPLE_SEMANTIC_MODEL_ELEMENT: {
				...
				if (result == null) result = caseDiagramElement(simpleSemanticModelElement);
				if (result == null) result = caseMethodElement(simpleSemanticModelElement);
				if (result == null) result = casePackageableElement(simpleSemanticModelElement);
				if (result == null) result = caseNamedElement(simpleSemanticModelElement);
				if (result == null) result = caseElement(simpleSemanticModelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.UMA_SEMANTIC_MODEL_BRIDGE: {
				...
				if (result == null) result = caseSemanticModelBridge(umaSemanticModelBridge);
				if (result == null) result = caseDiagramElement(umaSemanticModelBridge);
				if (result == null) result = caseMethodElement(umaSemanticModelBridge);
				if (result == null) result = casePackageableElement(umaSemanticModelBridge);
				if (result == null) result = caseNamedElement(umaSemanticModelBridge);
				if (result == null) result = caseElement(umaSemanticModelBridge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.CORE_SEMANTIC_MODEL_BRIDGE: {
				...
				if (result == null) result = caseDiagramElement(coreSemanticModelBridge);
				if (result == null) result = caseMethodElement(coreSemanticModelBridge);
				...
				if (result == null) result = caseElement(coreSemanticModelBridge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.LEAF_ELEMENT: {
				...
				if (result == null) result = caseMethodElement(leafElement);
				if (result == null) result = casePackageableElement(leafElement);
				if (result == null) result = caseNamedElement(leafElement);
				if (result == null) result = caseElement(leafElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.TEXT_ELEMENT: {
				...
				if (result == null) result = caseMethodElement(textElement);
				if (result == null) result = casePackageableElement(textElement);
				if (result == null) result = caseNamedElement(textElement);
			...
			case UmaPackage.IMAGE: {
				...
				if (result == null) result = caseMethodElement(image);
				if (result == null) result = casePackageableElement(image);
			...
			case UmaPackage.GRAPHIC_PRIMITIVE: {
				...
				if (result == null) result = caseMethodElement(graphicPrimitive);
				if (result == null) result = casePackageableElement(graphicPrimitive);
				if (result == null) result = caseNamedElement(graphicPrimitive);
				if (result == null) result = caseElement(graphicPrimitive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.POLYLINE: {
				...
				if (result == null) result = caseGraphicPrimitive(polyline);
				if (result == null) result = caseLeafElement(polyline);
				if (result == null) result = caseDiagramElement(polyline);
				if (result == null) result = caseMethodElement(polyline);
				if (result == null) result = casePackageableElement(polyline);
				if (result == null) result = caseNamedElement(polyline);
			...
			case UmaPackage.ELLIPSE: {
				...
				if (result == null) result = caseMethodElement(ellipse);
				if (result == null) result = casePackageableElement(ellipse);
				if (result == null) result = caseNamedElement(ellipse);
			...
			case UmaPackage.PROCESS_FAMILY: {
				...
				if (result == null) result = caseMethodConfiguration(processFamily);
				if (result == null) result = caseMethodUnit(processFamily);
				if (result == null) result = caseMethodElement(processFamily);
				if (result == null) result = casePackageableElement(processFamily);
				if (result == null) result = caseNamedElement(processFamily);
				if (result == null) result = caseElement(processFamily);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmaPackage.METHOD_LIBRARY: {
				...
				if (result == null) result = casePackage(methodLibrary);
				if (result == null) result = caseMethodElement(methodLibrary);
				if (result == null) result = caseNamespace(methodLibrary);
	 ...
	 * @generated
	 */
	public T casePackage(uma.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseProcess(uma.Process object) {
		return null;
	}
