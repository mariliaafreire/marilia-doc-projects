 ...
 *   <li>{@link br.ufrn.dimap.ase.dsl.expdslv3.impl.ProcessImpl#getTreatment <em>Treatment</em>}</li>
...
public class ProcessImpl extends MinimalEObjectImpl.Container implements br.ufrn.dimap.ase.dsl.expdslv3.Process
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected EList<Range> treatment;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EList<Range> getTreatment()
  {
		if (treatment == null) {
			treatment = new EObjectResolvingEList<Range>(Range.class, this, Expdslv3Package.PROCESS__TREATMENT);
		}
		return treatment;
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			case Expdslv3Package.PROCESS__NAME:
				return getName();
			case Expdslv3Package.PROCESS__TREATMENT:
				return getTreatment();
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			...
			case Expdslv3Package.PROCESS__TREATMENT:
				getTreatment().clear();
				getTreatment().addAll((Collection<? extends Range>)newValue);
				return;
			case Expdslv3Package.PROCESS__ROLE:
				getRole().clear();
