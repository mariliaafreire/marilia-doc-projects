 ...
 * <ul>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getIsSynchronizedWithSource <em>Is Synchronized With Source</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getTask <em>Task</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getAdditionallyPerformedBy <em>Additionally Performed By</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getAssistedBy <em>Assisted By</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getExternalInput <em>External Input</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getMandatoryInput <em>Mandatory Input</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getOptionalInput <em>Optional Input</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getPerformedPrimarilyBy <em>Performed Primarily By</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getSelectedSteps <em>Selected Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaskDescriptorImpl extends WorkBreakdownElementImpl implements TaskDescriptor {
	...
	public void setIsSynchronizedWithSource(Boolean newIsSynchronizedWithSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.TASK_DESCRIPTOR__IS_SYNCHRONIZED_WITH_SOURCE, oldIsSynchronizedWithSource, isSynchronizedWithSource));
	}
	...
	public Task getTask() {
		if (task != null && task.eIsProxy()) {
			...
			if (task != oldTask) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.TASK_DESCRIPTOR__TASK, oldTask, task));
			}
		}
		return task;
	}
	 ...
	 * @generated
	 */
	public EList<RoleDescriptor> getAdditionallyPerformedBy() {
		if (additionallyPerformedBy == null) {
			additionallyPerformedBy = new EObjectResolvingEList<RoleDescriptor>(RoleDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__ADDITIONALLY_PERFORMED_BY);
		}
	 ...
	 * @generated
	 */
	public EList<RoleDescriptor> getAssistedBy() {
		if (assistedBy == null) {
			assistedBy = new EObjectResolvingEList<RoleDescriptor>(RoleDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__ASSISTED_BY);
		}
		return assistedBy;
	}
	 ...
	 * @generated
	 */
	public EList<WorkProductDescriptor> getExternalInput() {
		if (externalInput == null) {
			externalInput = new EObjectResolvingEList<WorkProductDescriptor>(WorkProductDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__EXTERNAL_INPUT);
		}
	 ...
	 * @generated
	 */
	public EList<WorkProductDescriptor> getMandatoryInput() {
		if (mandatoryInput == null) {
			mandatoryInput = new EObjectResolvingEList<WorkProductDescriptor>(WorkProductDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__MANDATORY_INPUT);
		}
	 ...
	 * @generated
	 */
	public EList<WorkProductDescriptor> getOptionalInput() {
		if (optionalInput == null) {
			optionalInput = new EObjectResolvingEList<WorkProductDescriptor>(WorkProductDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__OPTIONAL_INPUT);
		}
	 ...
	 * @generated
	 */
	public EList<WorkProductDescriptor> getOutput() {
		if (output == null) {
			output = new EObjectResolvingEList<WorkProductDescriptor>(WorkProductDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__OUTPUT);
		}
		return output;
	}
	 ...
	 * @generated
	 */
	public EList<RoleDescriptor> getPerformedPrimarilyBy() {
		if (performedPrimarilyBy == null) {
			performedPrimarilyBy = new EObjectResolvingEList<RoleDescriptor>(RoleDescriptor.class, this, UmaPackage.TASK_DESCRIPTOR__PERFORMED_PRIMARILY_BY);
		}
	 ...
	 * @generated
	 */
	public EList<Section> getSelectedSteps() {
		if (selectedSteps == null) {
			selectedSteps = new EObjectResolvingEList<Section>(Section.class, this, UmaPackage.TASK_DESCRIPTOR__SELECTED_STEPS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UmaPackage.TASK_DESCRIPTOR__ADDITIONALLY_PERFORMED_BY:
				...
				getAdditionallyPerformedBy().addAll((Collection<? extends RoleDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__ASSISTED_BY:
				getAssistedBy().clear();
				getAssistedBy().addAll((Collection<? extends RoleDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__EXTERNAL_INPUT:
				getExternalInput().clear();
				getExternalInput().addAll((Collection<? extends WorkProductDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__MANDATORY_INPUT:
				getMandatoryInput().clear();
				getMandatoryInput().addAll((Collection<? extends WorkProductDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__OPTIONAL_INPUT:
				getOptionalInput().clear();
				getOptionalInput().addAll((Collection<? extends WorkProductDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__OUTPUT:
				getOutput().clear();
				getOutput().addAll((Collection<? extends WorkProductDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__PERFORMED_PRIMARILY_BY:
				getPerformedPrimarilyBy().clear();
				getPerformedPrimarilyBy().addAll((Collection<? extends RoleDescriptor>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__SELECTED_STEPS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UmaPackage.TASK_DESCRIPTOR__PERFORMED_PRIMARILY_BY:
				return performedPrimarilyBy != null && !performedPrimarilyBy.isEmpty();
			case UmaPackage.TASK_DESCRIPTOR__SELECTED_STEPS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Descriptor.class) {
			switch (derivedFeatureID) {
				case UmaPackage.TASK_DESCRIPTOR__IS_SYNCHRONIZED_WITH_SOURCE: return UmaPackage.DESCRIPTOR__IS_SYNCHRONIZED_WITH_SOURCE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Descriptor.class) {
			switch (baseFeatureID) {
				case UmaPackage.DESCRIPTOR__IS_SYNCHRONIZED_WITH_SOURCE: return UmaPackage.TASK_DESCRIPTOR__IS_SYNCHRONIZED_WITH_SOURCE;
				default: return -1;
			}
		}
