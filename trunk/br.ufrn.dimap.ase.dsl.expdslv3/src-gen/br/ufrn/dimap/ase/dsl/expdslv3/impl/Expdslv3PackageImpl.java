...
public class Expdslv3PackageImpl extends EPackageImpl implements Expdslv3Package
{
   ...
   * @generated
   */
  public EReference getLevel_Lev()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(levelEClass, LEVEL__LEV);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getFactor_Level(), this.getLevel(), null, "level", null, 0, -1, Factor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(levelEClass, Level.class, "Level", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLevel_Lev(), this.getRange(), null, "lev", null, 0, 1, Level.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(doeEClass, br.ufrn.dimap.ase.dsl.expdslv3.DOE.class, "DOE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDOE_Treatment(), this.getFactor(), null, "treatment", null, 0, 1, br.ufrn.dimap.ase.dsl.expdslv3.DOE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(lsEClass, br.ufrn.dimap.ase.dsl.expdslv3.LS.class, "LS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLS_Col(), this.getFactor(), null, "col", null, 0, 1, br.ufrn.dimap.ase.dsl.expdslv3.LS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getLS_Row(), this.getFactor(), null, "row", null, 0, 1, br.ufrn.dimap.ase.dsl.expdslv3.LS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRCBD_BlockVariable(), this.getFactor(), null, "blockVariable", null, 0, 1, br.ufrn.dimap.ase.dsl.expdslv3.RCBD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
