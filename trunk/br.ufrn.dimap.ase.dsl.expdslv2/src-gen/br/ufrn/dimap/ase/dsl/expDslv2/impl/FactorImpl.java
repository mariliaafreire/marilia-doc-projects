 ...
 * <ul>
 *   <li>{@link br.ufrn.dimap.ase.dsl.expDslv2.impl.FactorImpl#getName <em>Name</em>}</li>
 *   <li>{@link br.ufrn.dimap.ase.dsl.expDslv2.impl.FactorImpl#getIsDesiredVariation <em>Is Desired Variation</em>}</li>
 *   <li>{@link br.ufrn.dimap.ase.dsl.expDslv2.impl.FactorImpl#getLevel <em>Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FactorImpl extends MinimalEObjectImpl.Container implements Factor
{
  ...
  {
		return ExpDslv2Package.Literals.FACTOR;
	}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDslv2Package.FACTOR__NAME, oldName, name));
	}
  ...
  public void setIsDesiredVariation(String newIsDesiredVariation)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDslv2Package.FACTOR__IS_DESIRED_VARIATION, oldIsDesiredVariation, isDesiredVariation));
	}
  ...
  {
		if (level == null) {
			level = new EObjectContainmentEList<Levels>(Levels.class, this, ExpDslv2Package.FACTOR__LEVEL);
		}
		return level;
	}
  ...
  {
		switch (featureID) {
			case ExpDslv2Package.FACTOR__LEVEL:
  ...
  {
		switch (featureID) {
			case ExpDslv2Package.FACTOR__NAME:
				return getName();
			case ExpDslv2Package.FACTOR__IS_DESIRED_VARIATION:
