...
import MetricModel.MetricPlanModel;
...
public class MetricModelPackageImpl extends EPackageImpl implements MetricModelPackage {
	 ...
	 * @generated
	 */
	private EClass metricPlanModelEClass = null;
	 ...
	 * @generated
	 */
	public EClass getMetricPlanModel() {
		return metricPlanModelEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getMetricPlanModel_Name() {
		return (EAttribute)metricPlanModelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getMetricPlanModel_Metrics() {
		return (EReference)metricPlanModelEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		metricPlanModelEClass = createEClass(METRIC_PLAN_MODEL);
		createEAttribute(metricPlanModelEClass, METRIC_PLAN_MODEL__NAME);
		createEReference(metricPlanModelEClass, METRIC_PLAN_MODEL__METRICS);
	...
	public void initializePackageContents() {
		...
		initEClass(metricPlanModelEClass, MetricPlanModel.class, "MetricPlanModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMetricPlanModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, MetricPlanModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMetricPlanModel_Metrics(), this.getMetric(), null, "metrics", null, 0, -1, MetricPlanModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
