...
public class ArtefactImpl extends EObjectImpl implements Artefact {
	...
	protected EClass eStaticClass() {
		return Jpdl31Package.Literals.ARTEFACT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.ARTEFACT__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.ARTEFACT__DESCRIPTION, oldDescription, description));
	}
