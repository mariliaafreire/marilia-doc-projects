 ...
 *******************************************************************************/
package ICEISAcceleoProject.files;
...
/**
 * Entry point of the 'GenerateStartAction' generation module.
 *
 * @generated
 */
public class GenerateStartAction extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateStartAction";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateStartAction", };
	 ...
	 * @generated
	 */
	public GenerateStartAction(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateStartAction(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        GenerateStartAction generator = new GenerateStartAction(modelURI, folder, arguments);
    ...
    resourceSet.getPackageRegistry().put(jpdl31.Jpdl31Package.eINSTANCE.getNsURI(), jpdl31.Jpdl31Package.eINSTANCE);
