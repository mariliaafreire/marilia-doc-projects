 ...
 * <ul>
 *   <li>{@link uma.DeliveryProcess#getEducationMaterials <em>Education Materials</em>}</li>
 *   <li>{@link uma.DeliveryProcess#getCommunicationsMaterials <em>Communications Materials</em>}</li>
 * </ul>
 * </p>
 *
 * @see uma.UmaPackage#getDeliveryProcess()
 * @model
 * @generated
 */
public interface DeliveryProcess extends uma.Process {
	/**
	 ...
	 * @see uma.UmaPackage#getDeliveryProcess_EducationMaterials()
	 * @model ordered="false"
	 * @generated
	 */
	EList<SupportingMaterial> getEducationMaterials();
	 ...
	 * @see uma.UmaPackage#getDeliveryProcess_CommunicationsMaterials()
	 * @model ordered="false"
	 * @generated
	 */
	EList<SupportingMaterial> getCommunicationsMaterials();
