 ...
 * <ul>
 *   <li>{@link uma.impl.PracticeDescriptionImpl#getAdditionalInfo <em>Additional Info</em>}</li>
 *   <li>{@link uma.impl.PracticeDescriptionImpl#getProblem <em>Problem</em>}</li>
 *   <li>{@link uma.impl.PracticeDescriptionImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link uma.impl.PracticeDescriptionImpl#getGoals <em>Goals</em>}</li>
 *   <li>{@link uma.impl.PracticeDescriptionImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link uma.impl.PracticeDescriptionImpl#getLevelsOfAdoption <em>Levels Of Adoption</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
