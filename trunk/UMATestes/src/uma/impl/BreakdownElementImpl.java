 ...
 * <ul>
 *   <li>{@link uma.impl.BreakdownElementImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getIsPlanned <em>Is Planned</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getHasMultipleOccurrences <em>Has Multiple Occurrences</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getPresentedAfter <em>Presented After</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getPresentedBefore <em>Presented Before</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getPlanningData <em>Planning Data</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getSuperActivities <em>Super Activities</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getChecklists <em>Checklists</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getConcepts <em>Concepts</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getGuidelines <em>Guidelines</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getReusableAssets <em>Reusable Assets</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getSupportingMaterials <em>Supporting Materials</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getTemplates <em>Templates</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getReports <em>Reports</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getEstimationconsiderations <em>Estimationconsiderations</em>}</li>
 *   <li>{@link uma.impl.BreakdownElementImpl#getToolmentor <em>Toolmentor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BreakdownElementImpl extends ProcessElementImpl implements BreakdownElement {
	...
	public void setIsPlanned(Boolean newIsPlanned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__IS_PLANNED, oldIsPlanned, isPlanned));
	}
	...
	public void setHasMultipleOccurrences(Boolean newHasMultipleOccurrences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__HAS_MULTIPLE_OCCURRENCES, oldHasMultipleOccurrences, hasMultipleOccurrences));
	}
	...
	public void setIsOptional(Boolean newIsOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__IS_OPTIONAL, oldIsOptional, isOptional));
	}
	...
	public BreakdownElement getPresentedAfter() {
		if (presentedAfter != null && presentedAfter.eIsProxy()) {
			...
			if (presentedAfter != oldPresentedAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.BREAKDOWN_ELEMENT__PRESENTED_AFTER, oldPresentedAfter, presentedAfter));
			}
		}
	...
	public BreakdownElement getPresentedBefore() {
		if (presentedBefore != null && presentedBefore.eIsProxy()) {
			...
			if (presentedBefore != oldPresentedBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.BREAKDOWN_ELEMENT__PRESENTED_BEFORE, oldPresentedBefore, presentedBefore));
			}
		}
	...
	public NotificationChain basicSetPlanningData(PlanningData newPlanningData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__PLANNING_DATA, oldPlanningData, newPlanningData);
	...
	public void setPlanningData(PlanningData newPlanningData) {
		if (newPlanningData != planningData) {
			...
			if (planningData != null)
				msgs = ((InternalEObject)planningData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmaPackage.BREAKDOWN_ELEMENT__PLANNING_DATA, null, msgs);
			if (newPlanningData != null)
				msgs = ((InternalEObject)newPlanningData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmaPackage.BREAKDOWN_ELEMENT__PLANNING_DATA, null, msgs);
			msgs = basicSetPlanningData(newPlanningData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__PLANNING_DATA, newPlanningData, newPlanningData));
	}
	...
	public Activity getSuperActivities() {
		if (superActivities != null && superActivities.eIsProxy()) {
			...
			if (superActivities != oldSuperActivities) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.BREAKDOWN_ELEMENT__SUPER_ACTIVITIES, oldSuperActivities, superActivities));
			}
		}
	...
	public NotificationChain basicSetSuperActivities(Activity newSuperActivities, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__SUPER_ACTIVITIES, oldSuperActivities, newSuperActivities);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSuperActivities(Activity newSuperActivities) {
		if (newSuperActivities != superActivities) {
			...
			if (superActivities != null)
				msgs = ((InternalEObject)superActivities).eInverseRemove(this, UmaPackage.ACTIVITY__BREAKDOWN_ELEMENTS, Activity.class, msgs);
			if (newSuperActivities != null)
				msgs = ((InternalEObject)newSuperActivities).eInverseAdd(this, UmaPackage.ACTIVITY__BREAKDOWN_ELEMENTS, Activity.class, msgs);
			msgs = basicSetSuperActivities(newSuperActivities, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.BREAKDOWN_ELEMENT__SUPER_ACTIVITIES, newSuperActivities, newSuperActivities));
	}
	 ...
	 * @generated
	 */
	public EList<Checklist> getChecklists() {
		if (checklists == null) {
			checklists = new EObjectResolvingEList<Checklist>(Checklist.class, this, UmaPackage.BREAKDOWN_ELEMENT__CHECKLISTS);
		}
		return checklists;
	}
	 ...
	 * @generated
	 */
	public EList<Guideline> getGuidelines() {
		if (guidelines == null) {
			guidelines = new EObjectResolvingEList<Guideline>(Guideline.class, this, UmaPackage.BREAKDOWN_ELEMENT__GUIDELINES);
		}
		return guidelines;
	}
	 ...
	 * @generated
	 */
	public EList<ReusableAsset> getReusableAssets() {
		if (reusableAssets == null) {
			reusableAssets = new EObjectResolvingEList<ReusableAsset>(ReusableAsset.class, this, UmaPackage.BREAKDOWN_ELEMENT__REUSABLE_ASSETS);
		}
	 ...
	 * @generated
	 */
	public EList<SupportingMaterial> getSupportingMaterials() {
		if (supportingMaterials == null) {
			supportingMaterials = new EObjectResolvingEList<SupportingMaterial>(SupportingMaterial.class, this, UmaPackage.BREAKDOWN_ELEMENT__SUPPORTING_MATERIALS);
		}
	...
	public EList<Template> getTemplates() {
		if (templates == null) {
			templates = new EObjectResolvingEList<Template>(Template.class, this, UmaPackage.BREAKDOWN_ELEMENT__TEMPLATES);
		}
		return templates;
	}
	...
	public EList<EstimationConsiderations> getEstimationconsiderations() {
		if (estimationconsiderations == null) {
			estimationconsiderations = new EObjectResolvingEList<EstimationConsiderations>(EstimationConsiderations.class, this, UmaPackage.BREAKDOWN_ELEMENT__ESTIMATIONCONSIDERATIONS);
		}
	...
	public EList<ToolMentor> getToolmentor() {
		if (toolmentor == null) {
			toolmentor = new EObjectResolvingEList<ToolMentor>(ToolMentor.class, this, UmaPackage.BREAKDOWN_ELEMENT__TOOLMENTOR);
		}
		return toolmentor;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UmaPackage.BREAKDOWN_ELEMENT__HAS_MULTIPLE_OCCURRENCES:
				return HAS_MULTIPLE_OCCURRENCES_EDEFAULT == null ? hasMultipleOccurrences != null : !HAS_MULTIPLE_OCCURRENCES_EDEFAULT.equals(hasMultipleOccurrences);
			case UmaPackage.BREAKDOWN_ELEMENT__IS_OPTIONAL:
