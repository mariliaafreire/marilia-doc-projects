 ...
 * <ul>
 *   <li>{@link br.ufrn.dimap.ase.dsl.expDslv2.impl.LevelsImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LevelsImpl extends MinimalEObjectImpl.Container implements Levels
{
  ...
  {
		return ExpDslv2Package.Literals.LEVELS;
	}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDslv2Package.LEVELS__NAME, oldName, name));
	}
  ...
  {
		switch (featureID) {
			case ExpDslv2Package.LEVELS__NAME:
				return getName();
		}
