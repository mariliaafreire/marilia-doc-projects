 ...
 * <ul>
 *   <li>{@link uma.impl.DiagramLinkImpl#getZoom <em>Zoom</em>}</li>
 *   <li>{@link uma.impl.DiagramLinkImpl#getViewport <em>Viewport</em>}</li>
 *   <li>{@link uma.impl.DiagramLinkImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link uma.impl.DiagramLinkImpl#getGraphElement <em>Graph Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiagramLinkImpl extends DiagramElementImpl implements DiagramLink {
	...
	public Point getViewport() {
		if (viewport != null && viewport.eIsProxy()) {
			...
			if (viewport != oldViewport) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.DIAGRAM_LINK__VIEWPORT, oldViewport, viewport));
			}
		}
		return viewport;
	}
	...
	public void setViewport(Point newViewport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.DIAGRAM_LINK__VIEWPORT, oldViewport, viewport));
	}
	...
	public Diagram getDiagram() {
		if (diagram != null && diagram.eIsProxy()) {
			...
			if (diagram != oldDiagram) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.DIAGRAM_LINK__DIAGRAM, oldDiagram, diagram));
			}
		}
		return diagram;
	}
	...
	public NotificationChain basicSetDiagram(Diagram newDiagram, NotificationChain msgs) {
		...
		diagram = newDiagram;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmaPackage.DIAGRAM_LINK__DIAGRAM, oldDiagram, newDiagram);
	...
	public void setDiagram(Diagram newDiagram) {
		if (newDiagram != diagram) {
			...
			if (diagram != null)
				msgs = ((InternalEObject)diagram).eInverseRemove(this, UmaPackage.DIAGRAM__DIAGRAM_LINK, Diagram.class, msgs);
			if (newDiagram != null)
				msgs = ((InternalEObject)newDiagram).eInverseAdd(this, UmaPackage.DIAGRAM__DIAGRAM_LINK, Diagram.class, msgs);
			msgs = basicSetDiagram(newDiagram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.DIAGRAM_LINK__DIAGRAM, newDiagram, newDiagram));
	}
	...
	public void setGraphElement(GraphElement newGraphElement) {
		if (newGraphElement != eInternalContainer() || (eContainerFeatureID() != UmaPackage.DIAGRAM_LINK__GRAPH_ELEMENT && newGraphElement != null)) {
			...
			if (newGraphElement != null)
				msgs = ((InternalEObject)newGraphElement).eInverseAdd(this, UmaPackage.GRAPH_ELEMENT__LINK, GraphElement.class, msgs);
			msgs = basicSetGraphElement(newGraphElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.DIAGRAM_LINK__GRAPH_ELEMENT, newGraphElement, newGraphElement));
	}
