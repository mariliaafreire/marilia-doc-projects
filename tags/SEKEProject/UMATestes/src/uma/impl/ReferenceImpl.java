 ...
 * <ul>
 *   <li>{@link uma.impl.ReferenceImpl#getIsIndividualRepresentation <em>Is Individual Representation</em>}</li>
 *   <li>{@link uma.impl.ReferenceImpl#getReferenced <em>Referenced</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceImpl extends DiagramElementImpl implements Reference {
	...
	public void setIsIndividualRepresentation(Boolean newIsIndividualRepresentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.REFERENCE__IS_INDIVIDUAL_REPRESENTATION, oldIsIndividualRepresentation, isIndividualRepresentation));
	}
	...
	public DiagramElement getReferenced() {
		if (referenced != null && referenced.eIsProxy()) {
			...
			if (referenced != oldReferenced) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.REFERENCE__REFERENCED, oldReferenced, referenced));
			}
		}
		return referenced;
	}
	...
	public NotificationChain basicSetReferenced(DiagramElement newReferenced, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmaPackage.REFERENCE__REFERENCED, oldReferenced, newReferenced);
	...
	public void setReferenced(DiagramElement newReferenced) {
		if (newReferenced != referenced) {
			...
			if (referenced != null)
				msgs = ((InternalEObject)referenced).eInverseRemove(this, UmaPackage.DIAGRAM_ELEMENT__REFERENCE, DiagramElement.class, msgs);
			if (newReferenced != null)
				msgs = ((InternalEObject)newReferenced).eInverseAdd(this, UmaPackage.DIAGRAM_ELEMENT__REFERENCE, DiagramElement.class, msgs);
			msgs = basicSetReferenced(newReferenced, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.REFERENCE__REFERENCED, newReferenced, newReferenced));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case UmaPackage.REFERENCE__IS_INDIVIDUAL_REPRESENTATION:
				return IS_INDIVIDUAL_REPRESENTATION_EDEFAULT == null ? isIndividualRepresentation != null : !IS_INDIVIDUAL_REPRESENTATION_EDEFAULT.equals(isIndividualRepresentation);
			case UmaPackage.REFERENCE__REFERENCED:
