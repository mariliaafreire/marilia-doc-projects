 ...
 * <ul>
 *   <li>{@link uma.Task#getPerformedBy <em>Performed By</em>}</li>
 *   <li>{@link uma.Task#getMandatoryInput <em>Mandatory Input</em>}</li>
 *   <li>{@link uma.Task#getOutput <em>Output</em>}</li>
 *   <li>{@link uma.Task#getAdditionallyPerformedBy <em>Additionally Performed By</em>}</li>
 *   <li>{@link uma.Task#getOptionalInput <em>Optional Input</em>}</li>
 *   <li>{@link uma.Task#getSteps <em>Steps</em>}</li>
 *   <li>{@link uma.Task#getToolMentors <em>Tool Mentors</em>}</li>
 *   <li>{@link uma.Task#getEstimationConsiderations <em>Estimation Considerations</em>}</li>
 * </ul>
 * </p>
 *
 * @see uma.UmaPackage#getTask()
 * @model
 * @generated
 */
public interface Task extends ContentElement, WorkDefinition {
	 ...
	 * @see uma.UmaPackage#getTask_PerformedBy()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see uma.UmaPackage#getTask_MandatoryInput()
	 * @model ordered="false"
	 * @generated
	 */
	EList<WorkProduct> getMandatoryInput();
	 ...
	 * @see uma.UmaPackage#getTask_Output()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see uma.UmaPackage#getTask_AdditionallyPerformedBy()
	 * @model ordered="false"
	 * @generated
	 */
	EList<Role> getAdditionallyPerformedBy();
	 ...
	 * @see uma.UmaPackage#getTask_OptionalInput()
	 * @model ordered="false"
	 * @generated
	 */
	EList<WorkProduct> getOptionalInput();

	/**
	 * Returns the value of the '<em><b>Steps</b></em>' reference list.
	 * The list contents are of type {@link uma.Step}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uma.UmaPackage#getTask_Steps()
	 ...
	 * @see uma.UmaPackage#getTask_ToolMentors()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see uma.UmaPackage#getTask_EstimationConsiderations()
	 * @model ordered="false"
	 * @generated
	 */
