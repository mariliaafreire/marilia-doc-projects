...
public class MetricModelFactoryImpl extends EFactoryImpl implements MetricModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MetricModelPackage.METRIC_PLAN_MODEL: return createMetricPlanModel();
			default:
	 ...
	 * @generated
	 */
	public MetricPlanModel createMetricPlanModel() {
		MetricPlanModelImpl metricPlanModel = new MetricPlanModelImpl();
		return metricPlanModel;
	}
