 ...
 * <ul>
 *   <li>{@link uma.impl.ContentElementImpl#getVariabilityType <em>Variability Type</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getVariabilityBasedOnElement <em>Variability Based On Element</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getSupportingMaterials <em>Supporting Materials</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getConceptsAndPapers <em>Concepts And Papers</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getChecklists <em>Checklists</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getGuidelines <em>Guidelines</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link uma.impl.ContentElementImpl#getTermdefinition <em>Termdefinition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ContentElementImpl extends DescribableElementImpl implements ContentElement {
	...
	public void setVariabilityType(VariabilityType newVariabilityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.CONTENT_ELEMENT__VARIABILITY_TYPE, oldVariabilityType, variabilityType));
	}
	...
	public VariabilityElement getVariabilityBasedOnElement() {
		if (variabilityBasedOnElement != null && variabilityBasedOnElement.eIsProxy()) {
			...
			if (variabilityBasedOnElement != oldVariabilityBasedOnElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.CONTENT_ELEMENT__VARIABILITY_BASED_ON_ELEMENT, oldVariabilityBasedOnElement, variabilityBasedOnElement));
			}
		}
	...
	public EList<SupportingMaterial> getSupportingMaterials() {
		if (supportingMaterials == null) {
			supportingMaterials = new EObjectResolvingEList<SupportingMaterial>(SupportingMaterial.class, this, UmaPackage.CONTENT_ELEMENT__SUPPORTING_MATERIALS);
		}
	 ...
	 * @generated
	 */
	public EList<Concept> getConceptsAndPapers() {
		if (conceptsAndPapers == null) {
			conceptsAndPapers = new EObjectResolvingEList<Concept>(Concept.class, this, UmaPackage.CONTENT_ELEMENT__CONCEPTS_AND_PAPERS);
		}
	...
	public EList<Checklist> getChecklists() {
		if (checklists == null) {
			checklists = new EObjectResolvingEList<Checklist>(Checklist.class, this, UmaPackage.CONTENT_ELEMENT__CHECKLISTS);
		}
		return checklists;
	}
	...
	public EList<Guideline> getGuidelines() {
		if (guidelines == null) {
			guidelines = new EObjectResolvingEList<Guideline>(Guideline.class, this, UmaPackage.CONTENT_ELEMENT__GUIDELINES);
		}
		return guidelines;
	}
	 ...
	 * @generated
	 */
	public EList<ReusableAsset> getAssets() {
		if (assets == null) {
			assets = new EObjectResolvingEList<ReusableAsset>(ReusableAsset.class, this, UmaPackage.CONTENT_ELEMENT__ASSETS);
		}
		return assets;
	}
	...
	public EList<TermDefinition> getTermdefinition() {
		if (termdefinition == null) {
			termdefinition = new EObjectResolvingEList<TermDefinition>(TermDefinition.class, this, UmaPackage.CONTENT_ELEMENT__TERMDEFINITION);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == VariabilityElement.class) {
			switch (derivedFeatureID) {
				case UmaPackage.CONTENT_ELEMENT__VARIABILITY_TYPE: return UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_TYPE;
				case UmaPackage.CONTENT_ELEMENT__VARIABILITY_BASED_ON_ELEMENT: return UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_BASED_ON_ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == VariabilityElement.class) {
			switch (baseFeatureID) {
				case UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_TYPE: return UmaPackage.CONTENT_ELEMENT__VARIABILITY_TYPE;
				case UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_BASED_ON_ELEMENT: return UmaPackage.CONTENT_ELEMENT__VARIABILITY_BASED_ON_ELEMENT;
				default: return -1;
			}
		}
