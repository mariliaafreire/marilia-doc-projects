 ...
 *   <li>{@link br.ufrn.dimap.ase.dsl.expdslv3.impl.ExperimentalDesignImpl#getReplication <em>Replication</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExperimentalDesignImpl extends MinimalEObjectImpl.Container implements ExperimentalDesign
{
  ...
  public void setReplication(int newReplication)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Expdslv3Package.EXPERIMENTAL_DESIGN__REPLICATION, oldReplication, replication));
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			...
			case Expdslv3Package.EXPERIMENTAL_DESIGN__PARAMETER:
				return getParameter();
			case Expdslv3Package.EXPERIMENTAL_DESIGN__REPLICATION:
