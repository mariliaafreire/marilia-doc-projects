 ...
 * <ul>
 *   <li>{@link jpdl31.impl.MetricImpl#getNome <em>Nome</em>}</li>
...
public class MetricImpl extends EObjectImpl implements Metric {
	...
	public void setNome(String newNome) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.METRIC__NOME, oldNome, nome));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Jpdl31Package.METRIC__NOME:
				return getNome();
