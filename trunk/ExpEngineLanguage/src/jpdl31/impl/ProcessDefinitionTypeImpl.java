 ...
 *   <li>{@link jpdl31.impl.ProcessDefinitionTypeImpl#getQuantity <em>Quantity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessDefinitionTypeImpl extends EObjectImpl implements ProcessDefinitionType {
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.PROCESS_DEFINITION_TYPE__QUANTITY, oldQuantity, quantity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Jpdl31Package.PROCESS_DEFINITION_TYPE__NAME:
				return getName();
			case Jpdl31Package.PROCESS_DEFINITION_TYPE__QUANTITY:
				return getQuantity();
		}
