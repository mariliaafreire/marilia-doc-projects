 ...
 * <ul>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getNodeContentElements <em>Node Content Elements</em>}</li>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getExceptionHandler <em>Exception Handler</em>}</li>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getTimer <em>Timer</em>}</li>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getAsync <em>Async</em>}</li>
 *   <li>{@link jpdl31.impl.JoinTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinTypeImpl extends EObjectImpl implements JoinType {
	...
	protected EClass eStaticClass() {
		return Jpdl31Package.Literals.JOIN_TYPE;
	}
	...
	public FeatureMap getNodeContentElements() {
		if (nodeContentElements == null) {
			nodeContentElements = new BasicFeatureMap(this, Jpdl31Package.JOIN_TYPE__NODE_CONTENT_ELEMENTS);
		}
	...
	public EList<EventType> getEvent() {
		return getNodeContentElements().list(Jpdl31Package.Literals.JOIN_TYPE__EVENT);
	}
	...
	public EList<ExceptionHandlerType> getExceptionHandler() {
		return getNodeContentElements().list(Jpdl31Package.Literals.JOIN_TYPE__EXCEPTION_HANDLER);
	}
	...
	public EList<TimerType> getTimer() {
		return getNodeContentElements().list(Jpdl31Package.Literals.JOIN_TYPE__TIMER);
	}
	...
	public EList<TransitionType> getTransition() {
		return getNodeContentElements().list(Jpdl31Package.Literals.JOIN_TYPE__TRANSITION);
	}
	...
	public void setAsync(String newAsync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.JOIN_TYPE__ASYNC, oldAsync, async, !oldAsyncESet));
	}
	...
	public void unsetAsync() {
		...
		asyncESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Jpdl31Package.JOIN_TYPE__ASYNC, oldAsync, ASYNC_EDEFAULT, oldAsyncESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.JOIN_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Jpdl31Package.JOIN_TYPE__NODE_CONTENT_ELEMENTS:
				return ((InternalEList<?>)getNodeContentElements()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.JOIN_TYPE__EVENT:
				return ((InternalEList<?>)getEvent()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.JOIN_TYPE__EXCEPTION_HANDLER:
				return ((InternalEList<?>)getExceptionHandler()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.JOIN_TYPE__TIMER:
				return ((InternalEList<?>)getTimer()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.JOIN_TYPE__TRANSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Jpdl31Package.JOIN_TYPE__ASYNC:
				return getAsync();
			case Jpdl31Package.JOIN_TYPE__NAME:
				return getName();
		}
