 ...
 * <ul>
 *   <li>{@link uma.impl.VariabilityElementImpl#getVariabilityType <em>Variability Type</em>}</li>
 *   <li>{@link uma.impl.VariabilityElementImpl#getVariabilityBasedOnElement <em>Variability Based On Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VariabilityElementImpl extends MethodElementImpl implements VariabilityElement {
	...
	public void setVariabilityType(VariabilityType newVariabilityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_TYPE, oldVariabilityType, variabilityType));
	}
	...
	public VariabilityElement getVariabilityBasedOnElement() {
		if (variabilityBasedOnElement != null && variabilityBasedOnElement.eIsProxy()) {
			...
			if (variabilityBasedOnElement != oldVariabilityBasedOnElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_BASED_ON_ELEMENT, oldVariabilityBasedOnElement, variabilityBasedOnElement));
			}
		}
	...
	public void setVariabilityBasedOnElement(VariabilityElement newVariabilityBasedOnElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.VARIABILITY_ELEMENT__VARIABILITY_BASED_ON_ELEMENT, oldVariabilityBasedOnElement, variabilityBasedOnElement));
	}
