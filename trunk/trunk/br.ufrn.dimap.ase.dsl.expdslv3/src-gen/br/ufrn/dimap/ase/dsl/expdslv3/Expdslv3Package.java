...
public interface Expdslv3Package extends EPackage
{
   ...
   * @ordered
   */
  int EXPERIMENTAL_DESIGN_FEATURE_COUNT = 12;
  ...
  /**
   * The meta object id for the '{@link br.ufrn.dimap.ase.dsl.expdslv3.impl.LevelImpl <em>Level</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see br.ufrn.dimap.ase.dsl.expdslv3.impl.LevelImpl
   * @see br.ufrn.dimap.ase.dsl.expdslv3.impl.Expdslv3PackageImpl#getLevel()
   * @generated
   */
  int LEVEL = 15;

  /**
   * The feature id for the '<em><b>Lev</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for the attribute '{@link br.ufrn.dimap.ase.dsl.expdslv3.Goal#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see br.ufrn.dimap.ase.dsl.expdslv3.Goal#getName()
   * @see #getGoal()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link br.ufrn.dimap.ase.dsl.expdslv3.Goal#getDescription <em>Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Description</em>'.
   * @see br.ufrn.dimap.ase.dsl.expdslv3.Goal#getDescription()
   * @see #getGoal()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the reference '{@link br.ufrn.dimap.ase.dsl.expdslv3.Factor#getVariable <em>Variable</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Variable</em>'.
   * @see br.ufrn.dimap.ase.dsl.expdslv3.Factor#getVariable()
   * @see #getFactor()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference list '{@link br.ufrn.dimap.ase.dsl.expdslv3.Factor#getLevel <em>Level</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Level</em>'.
   * @see br.ufrn.dimap.ase.dsl.expdslv3.Factor#getLevel()
   * @see #getFactor()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link br.ufrn.dimap.ase.dsl.expdslv3.Level <em>Level</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the reference '{@link br.ufrn.dimap.ase.dsl.expdslv3.Level#getLev <em>Lev</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Lev</em>'.
   * @see br.ufrn.dimap.ase.dsl.expdslv3.Level#getLev()
   * @see #getLevel()
   * @generated
   */
  EReference getLevel_Lev();
  ...
  /**
   * Returns the meta object for the attribute '{@link br.ufrn.dimap.ase.dsl.expdslv3.Parameter#getVariable <em>Variable</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link br.ufrn.dimap.ase.dsl.expdslv3.Parameter#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Value</em>'.
   * @see br.ufrn.dimap.ase.dsl.expdslv3.Parameter#getValue()
   * @see #getParameter()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link br.ufrn.dimap.ase.dsl.expdslv3.impl.LevelImpl <em>Level</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see br.ufrn.dimap.ase.dsl.expdslv3.impl.LevelImpl
     * @see br.ufrn.dimap.ase.dsl.expdslv3.impl.Expdslv3PackageImpl#getLevel()
    ...
    /**
     * The meta object literal for the '<em><b>Lev</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference LEVEL__LEV = eINSTANCE.getLevel_Lev();
