 ...
 * <ul>
 *   <li>{@link uma.WorkOrder#getLinkType <em>Link Type</em>}</li>
 *   <li>{@link uma.WorkOrder#getPred <em>Pred</em>}</li>
 * </ul>
 * </p>
 *
 * @see uma.UmaPackage#getWorkOrder()
 * @model
 * @generated
 */
public interface WorkOrder extends ProcessElement {
	 ...
	 * The literals are from the enumeration {@link uma.WorkOrderType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uma.UmaPackage#getWorkOrder_LinkType()
	...
	/**
	 * Sets the value of the '{@link uma.WorkOrder#getLinkType <em>Link Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uma.UmaPackage#getWorkOrder_Pred()
	...
	/**
	 * Sets the value of the '{@link uma.WorkOrder#getPred <em>Pred</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
