 ...
 * <ul>
 *   <li>{@link uma.impl.ProcessComponentImpl#getAuthors <em>Authors</em>}</li>
 *   <li>{@link uma.impl.ProcessComponentImpl#getChangeDate <em>Change Date</em>}</li>
 *   <li>{@link uma.impl.ProcessComponentImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link uma.impl.ProcessComponentImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link uma.impl.ProcessComponentImpl#getCopyrightStatement <em>Copyright Statement</em>}</li>
 *   <li>{@link uma.impl.ProcessComponentImpl#getInterfaces <em>Interfaces</em>}</li>
 *   <li>{@link uma.impl.ProcessComponentImpl#getProcess <em>Process</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessComponentImpl extends ProcessPackageImpl implements ProcessComponent {
	...
	public SupportingMaterial getCopyrightStatement() {
		if (copyrightStatement != null && copyrightStatement.eIsProxy()) {
			...
			if (copyrightStatement != oldCopyrightStatement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.PROCESS_COMPONENT__COPYRIGHT_STATEMENT, oldCopyrightStatement, copyrightStatement));
			}
		}
	...
	public void setCopyrightStatement(SupportingMaterial newCopyrightStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.PROCESS_COMPONENT__COPYRIGHT_STATEMENT, oldCopyrightStatement, copyrightStatement));
	}
	 ...
	 * @generated
	 */
	public EList<ProcessComponentInterface> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectResolvingEList<ProcessComponentInterface>(ProcessComponentInterface.class, this, UmaPackage.PROCESS_COMPONENT__INTERFACES);
		}
		return interfaces;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProcess(uma.Process newProcess, NotificationChain msgs) {
		uma.Process oldProcess = process;
		process = newProcess;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setProcess(uma.Process newProcess) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UmaPackage.PROCESS_COMPONENT__INTERFACES:
				...
				return;
			case UmaPackage.PROCESS_COMPONENT__PROCESS:
				setProcess((uma.Process)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MethodUnit.class) {
			switch (derivedFeatureID) {
				case UmaPackage.PROCESS_COMPONENT__AUTHORS: return UmaPackage.METHOD_UNIT__AUTHORS;
				case UmaPackage.PROCESS_COMPONENT__CHANGE_DATE: return UmaPackage.METHOD_UNIT__CHANGE_DATE;
				case UmaPackage.PROCESS_COMPONENT__CHANGE_DESCRIPTION: return UmaPackage.METHOD_UNIT__CHANGE_DESCRIPTION;
				case UmaPackage.PROCESS_COMPONENT__VERSION: return UmaPackage.METHOD_UNIT__VERSION;
				case UmaPackage.PROCESS_COMPONENT__COPYRIGHT_STATEMENT: return UmaPackage.METHOD_UNIT__COPYRIGHT_STATEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MethodUnit.class) {
			switch (baseFeatureID) {
				case UmaPackage.METHOD_UNIT__AUTHORS: return UmaPackage.PROCESS_COMPONENT__AUTHORS;
				case UmaPackage.METHOD_UNIT__CHANGE_DATE: return UmaPackage.PROCESS_COMPONENT__CHANGE_DATE;
				case UmaPackage.METHOD_UNIT__CHANGE_DESCRIPTION: return UmaPackage.PROCESS_COMPONENT__CHANGE_DESCRIPTION;
				case UmaPackage.METHOD_UNIT__VERSION: return UmaPackage.PROCESS_COMPONENT__VERSION;
				case UmaPackage.METHOD_UNIT__COPYRIGHT_STATEMENT: return UmaPackage.PROCESS_COMPONENT__COPYRIGHT_STATEMENT;
				default: return -1;
			}
		}
