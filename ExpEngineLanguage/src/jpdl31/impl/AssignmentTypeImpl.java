 ...
 * <ul>
 *   <li>{@link jpdl31.impl.AssignmentTypeImpl#getActorId <em>Actor Id</em>}</li>
 *   <li>{@link jpdl31.impl.AssignmentTypeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link jpdl31.impl.AssignmentTypeImpl#getPooledActors <em>Pooled Actors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssignmentTypeImpl extends DelegationImpl implements AssignmentType {
	...
	protected EClass eStaticClass() {
		return Jpdl31Package.Literals.ASSIGNMENT_TYPE;
	}
	...
	public void setActorId(String newActorId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.ASSIGNMENT_TYPE__ACTOR_ID, oldActorId, actorId));
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.ASSIGNMENT_TYPE__EXPRESSION, oldExpression, expression));
	}
	...
	public void setPooledActors(String newPooledActors) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.ASSIGNMENT_TYPE__POOLED_ACTORS, oldPooledActors, pooledActors));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Jpdl31Package.ASSIGNMENT_TYPE__ACTOR_ID:
				return getActorId();
			case Jpdl31Package.ASSIGNMENT_TYPE__EXPRESSION:
				return getExpression();
			case Jpdl31Package.ASSIGNMENT_TYPE__POOLED_ACTORS:
