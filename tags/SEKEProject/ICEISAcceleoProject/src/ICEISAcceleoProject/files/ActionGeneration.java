...
/**
 * Entry point of the 'ActionGeneration' generation module.
 *
 * @generated
 */
public class ActionGeneration extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "actionGeneration";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "actionGeneration", };
	 ...
	 * @generated
	 */
	public ActionGeneration(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public ActionGeneration(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        ActionGeneration generator = new ActionGeneration(modelURI, folder, arguments);
