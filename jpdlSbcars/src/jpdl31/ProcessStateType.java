 ...
 * <ul>
 *   <li>{@link jpdl31.ProcessStateType#getGroup <em>Group</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getSubProcess <em>Sub Process</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getVariable <em>Variable</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getEvent <em>Event</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getExceptionHandler <em>Exception Handler</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getTimer <em>Timer</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getTransition <em>Transition</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getAsync <em>Async</em>}</li>
 *   <li>{@link jpdl31.ProcessStateType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see jpdl31.Jpdl31Package#getProcessStateType()
...
public interface ProcessStateType extends EObject {
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Group()
	 ...
	 * The list contents are of type {@link jpdl31.SubProcessType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_SubProcess()
	 ...
	 * The list contents are of type {@link jpdl31.VariableType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Variable()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Event()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_ExceptionHandler()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Timer()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Transition()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #unsetAsync()
	 * @see #setAsync(String)
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Async()
	...
	/**
	 * Sets the value of the '{@link jpdl31.ProcessStateType#getAsync <em>Async</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link jpdl31.ProcessStateType#getAsync <em>Async</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetAsync()
	 * @see #getAsync()
	...
	/**
	 * Returns whether the value of the '{@link jpdl31.ProcessStateType#getAsync <em>Async</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see jpdl31.Jpdl31Package#getProcessStateType_Name()
	...
	/**
	 * Sets the value of the '{@link jpdl31.ProcessStateType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
