...
/**
 * Entry point of the 'Startxhtml' generation module.
 *
 * @generated
 */
public class Startxhtml extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "startxhtml";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "startxhtml", };
	 ...
	 * @generated
	 */
	public Startxhtml(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Startxhtml(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				Startxhtml generator = new Startxhtml(modelURI, folder, arguments);
