...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Config Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see jpdl31.Jpdl31Package#getConfigTypeType()
 * @model extendedMetaData="name='config-type_._1_._type'"
 * @generated
 */
public enum ConfigTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Config Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ConfigTypeType[] VALUES_ARRAY =
		new ConfigTypeType[] {
			FIELD,
			BEAN,
			CONSTRUCTOR,
	...
	/**
	 * A public read-only list of all the '<em><b>Config Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ConfigTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Config Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConfigTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConfigTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Config Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConfigTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConfigTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Config Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConfigTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ConfigTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
