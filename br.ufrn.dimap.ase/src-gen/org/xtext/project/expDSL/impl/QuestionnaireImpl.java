 ...
 * <ul>
 *   <li>{@link org.xtext.project.expDSL.impl.QuestionnaireImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.project.expDSL.impl.QuestionnaireImpl#getRelatesTo <em>Relates To</em>}</li>
 *   <li>{@link org.xtext.project.expDSL.impl.QuestionnaireImpl#getQuestionnaireType <em>Questionnaire Type</em>}</li>
 *   <li>{@link org.xtext.project.expDSL.impl.QuestionnaireImpl#getQuestion <em>Question</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QuestionnaireImpl extends MinimalEObjectImpl.Container implements Questionnaire
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected EList<org.xtext.project.expDSL.Process> relatesTo;
  ...
  {
		return ExpDSLPackage.Literals.QUESTIONNAIRE;
	}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDSLPackage.QUESTIONNAIRE__NAME, oldName, name));
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EList<org.xtext.project.expDSL.Process> getRelatesTo()
  {
		if (relatesTo == null) {
			relatesTo = new EObjectResolvingEList<org.xtext.project.expDSL.Process>(org.xtext.project.expDSL.Process.class, this, ExpDSLPackage.QUESTIONNAIRE__RELATES_TO);
		}
		return relatesTo;
	}
  ...
  public void setQuestionnaireType(QuestionnaireType newQuestionnaireType)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDSLPackage.QUESTIONNAIRE__QUESTIONNAIRE_TYPE, oldQuestionnaireType, questionnaireType));
	}
  ...
  {
		if (question == null) {
			question = new EObjectContainmentEList<Question>(Question.class, this, ExpDSLPackage.QUESTIONNAIRE__QUESTION);
		}
		return question;
	}
  ...
  {
		switch (featureID) {
			case ExpDSLPackage.QUESTIONNAIRE__QUESTION:
  ...
  {
		switch (featureID) {
			case ExpDSLPackage.QUESTIONNAIRE__NAME:
				return getName();
			case ExpDSLPackage.QUESTIONNAIRE__RELATES_TO:
				return getRelatesTo();
			case ExpDSLPackage.QUESTIONNAIRE__QUESTIONNAIRE_TYPE:
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			...
			case ExpDSLPackage.QUESTIONNAIRE__RELATES_TO:
				getRelatesTo().clear();
				getRelatesTo().addAll((Collection<? extends org.xtext.project.expDSL.Process>)newValue);
				return;
			case ExpDSLPackage.QUESTIONNAIRE__QUESTIONNAIRE_TYPE:
