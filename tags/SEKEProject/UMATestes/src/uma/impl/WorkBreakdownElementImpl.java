 ...
 * <ul>
 *   <li>{@link uma.impl.WorkBreakdownElementImpl#getIsRepeatable <em>Is Repeatable</em>}</li>
 *   <li>{@link uma.impl.WorkBreakdownElementImpl#getIsOngoing <em>Is Ongoing</em>}</li>
 *   <li>{@link uma.impl.WorkBreakdownElementImpl#getIsEventDriven <em>Is Event Driven</em>}</li>
 *   <li>{@link uma.impl.WorkBreakdownElementImpl#getLinkToPredecessor <em>Link To Predecessor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class WorkBreakdownElementImpl extends BreakdownElementImpl implements WorkBreakdownElement {
	...
	public void setIsRepeatable(Boolean newIsRepeatable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.WORK_BREAKDOWN_ELEMENT__IS_REPEATABLE, oldIsRepeatable, isRepeatable));
	}
	...
	public void setIsOngoing(Boolean newIsOngoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.WORK_BREAKDOWN_ELEMENT__IS_ONGOING, oldIsOngoing, isOngoing));
	}
	...
	public void setIsEventDriven(Boolean newIsEventDriven) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.WORK_BREAKDOWN_ELEMENT__IS_EVENT_DRIVEN, oldIsEventDriven, isEventDriven));
	}
	 ...
	 * @generated
	 */
	public EList<WorkOrder> getLinkToPredecessor() {
		if (linkToPredecessor == null) {
			linkToPredecessor = new EObjectResolvingEList<WorkOrder>(WorkOrder.class, this, UmaPackage.WORK_BREAKDOWN_ELEMENT__LINK_TO_PREDECESSOR);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UmaPackage.WORK_BREAKDOWN_ELEMENT__IS_EVENT_DRIVEN:
				return IS_EVENT_DRIVEN_EDEFAULT == null ? isEventDriven != null : !IS_EVENT_DRIVEN_EDEFAULT.equals(isEventDriven);
			case UmaPackage.WORK_BREAKDOWN_ELEMENT__LINK_TO_PREDECESSOR:
