 ...
 * <ul>
 *   <li>{@link uma.WorkDefinition#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link uma.WorkDefinition#getPostcondition <em>Postcondition</em>}</li>
 * </ul>
 * </p>
 *
 * @see uma.UmaPackage#getWorkDefinition()
 * @model abstract="true"
 * @generated
 */
public interface WorkDefinition extends MethodElement {
	 ...
	 * @see uma.UmaPackage#getWorkDefinition_Precondition()
	...
	/**
	 * Sets the value of the '{@link uma.WorkDefinition#getPrecondition <em>Precondition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uma.UmaPackage#getWorkDefinition_Postcondition()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uma.WorkDefinition#getPostcondition <em>Postcondition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
