 ...
 * <ul>
 *   <li>{@link br.ufrn.dimap.ase.dsl.expDslv2.impl.AlternativesImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AlternativesImpl extends MinimalEObjectImpl.Container implements Alternatives
{
  ...
  {
		return ExpDslv2Package.Literals.ALTERNATIVES;
	}
  ...
  public void setDescription(String newDescription)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDslv2Package.ALTERNATIVES__DESCRIPTION, oldDescription, description));
	}
  ...
  {
		switch (featureID) {
			case ExpDslv2Package.ALTERNATIVES__DESCRIPTION:
