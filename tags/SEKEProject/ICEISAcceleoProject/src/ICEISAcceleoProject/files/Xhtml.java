...
/**
 * Entry point of the 'Xhtml.mtl' generation module.
 *
 * @generated
 */
public class Xhtml extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "xhtml";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "xhtml", };
	 ...
	 * @generated
	 */
	public Xhtml(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Xhtml(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Xhtml generator = new Xhtml(modelURI, folder, arguments);
