 ...
 * @generated
 */
public class MetricModelSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MetricModelPackage.METRIC: {
				Metric metric = (Metric)theEObject;
				T result = caseMetric(metric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetricModelPackage.ACTIVITY_METRIC: {
				ActivityMetric activityMetric = (ActivityMetric)theEObject;
				T result = caseActivityMetric(activityMetric);
				if (result == null) result = caseMetric(activityMetric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetricModelPackage.TASK_METRIC: {
				TaskMetric taskMetric = (TaskMetric)theEObject;
				T result = caseTaskMetric(taskMetric);
				if (result == null) result = caseMetric(taskMetric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetricModelPackage.METRIC_MODEL_PLAN: {
				MetricModelPlan metricModelPlan = (MetricModelPlan)theEObject;
				T result = caseMetricModelPlan(metricModelPlan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseMetricModelPlan(MetricModelPlan object) {
		return null;
	}
