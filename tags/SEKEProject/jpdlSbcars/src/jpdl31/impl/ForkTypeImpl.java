 ...
 * <ul>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getExceptionHandler <em>Exception Handler</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getTimer <em>Timer</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getAsync <em>Async</em>}</li>
 *   <li>{@link jpdl31.impl.ForkTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForkTypeImpl extends EObjectImpl implements ForkType {
	...
	protected EClass eStaticClass() {
		return Jpdl31Package.Literals.FORK_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Jpdl31Package.FORK_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ScriptType> getScript() {
		return getGroup().list(Jpdl31Package.Literals.FORK_TYPE__SCRIPT);
	}
	...
	public EList<EventType> getEvent() {
		return getGroup().list(Jpdl31Package.Literals.FORK_TYPE__EVENT);
	}
	...
	public EList<ExceptionHandlerType> getExceptionHandler() {
		return getGroup().list(Jpdl31Package.Literals.FORK_TYPE__EXCEPTION_HANDLER);
	}
	...
	public EList<TimerType> getTimer() {
		return getGroup().list(Jpdl31Package.Literals.FORK_TYPE__TIMER);
	}
	...
	public EList<TransitionType> getTransition() {
		return getGroup().list(Jpdl31Package.Literals.FORK_TYPE__TRANSITION);
	}
	...
	public void setAsync(String newAsync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.FORK_TYPE__ASYNC, oldAsync, async, !oldAsyncESet));
	}
	...
	public void unsetAsync() {
		...
		asyncESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Jpdl31Package.FORK_TYPE__ASYNC, oldAsync, ASYNC_EDEFAULT, oldAsyncESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jpdl31Package.FORK_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Jpdl31Package.FORK_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.FORK_TYPE__SCRIPT:
				return ((InternalEList<?>)getScript()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.FORK_TYPE__EVENT:
				return ((InternalEList<?>)getEvent()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.FORK_TYPE__EXCEPTION_HANDLER:
				return ((InternalEList<?>)getExceptionHandler()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.FORK_TYPE__TIMER:
				return ((InternalEList<?>)getTimer()).basicRemove(otherEnd, msgs);
			case Jpdl31Package.FORK_TYPE__TRANSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Jpdl31Package.FORK_TYPE__ASYNC:
				return getAsync();
			case Jpdl31Package.FORK_TYPE__NAME:
				return getName();
		}
