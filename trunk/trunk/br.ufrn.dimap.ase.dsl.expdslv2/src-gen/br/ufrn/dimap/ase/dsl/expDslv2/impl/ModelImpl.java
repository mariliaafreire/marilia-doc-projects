 ...
 * <ul>
 *   <li>{@link br.ufrn.dimap.ase.dsl.expDslv2.impl.ModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
		return ExpDslv2Package.Literals.MODEL;
	}
  ...
  {
		if (elements == null) {
			elements = new EObjectContainmentEList<ExperimentElement>(ExperimentElement.class, this, ExpDslv2Package.MODEL__ELEMENTS);
		}
		return elements;
	}
  ...
  {
		switch (featureID) {
			case ExpDslv2Package.MODEL__ELEMENTS:
