 ...
 * <ul>
 *   <li>{@link uma.impl.TeamProfileImpl#getTeamRoles <em>Team Roles</em>}</li>
 *   <li>{@link uma.impl.TeamProfileImpl#getSuperTeam <em>Super Team</em>}</li>
 *   <li>{@link uma.impl.TeamProfileImpl#getSubTeam <em>Sub Team</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TeamProfileImpl extends BreakdownElementImpl implements TeamProfile {
	 ...
	 * @generated
	 */
	public EList<RoleDescriptor> getTeamRoles() {
		if (teamRoles == null) {
			teamRoles = new EObjectResolvingEList<RoleDescriptor>(RoleDescriptor.class, this, UmaPackage.TEAM_PROFILE__TEAM_ROLES);
		}
		return teamRoles;
	}
	...
	public TeamProfile getSuperTeam() {
		if (superTeam != null && superTeam.eIsProxy()) {
			...
			if (superTeam != oldSuperTeam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmaPackage.TEAM_PROFILE__SUPER_TEAM, oldSuperTeam, superTeam));
			}
		}
		return superTeam;
	}
	...
	public NotificationChain basicSetSuperTeam(TeamProfile newSuperTeam, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmaPackage.TEAM_PROFILE__SUPER_TEAM, oldSuperTeam, newSuperTeam);
	...
	public void setSuperTeam(TeamProfile newSuperTeam) {
		if (newSuperTeam != superTeam) {
			...
			if (superTeam != null)
				msgs = ((InternalEObject)superTeam).eInverseRemove(this, UmaPackage.TEAM_PROFILE__SUB_TEAM, TeamProfile.class, msgs);
			if (newSuperTeam != null)
				msgs = ((InternalEObject)newSuperTeam).eInverseAdd(this, UmaPackage.TEAM_PROFILE__SUB_TEAM, TeamProfile.class, msgs);
			msgs = basicSetSuperTeam(newSuperTeam, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmaPackage.TEAM_PROFILE__SUPER_TEAM, newSuperTeam, newSuperTeam));
	}
	...
	public EList<TeamProfile> getSubTeam() {
		if (subTeam == null) {
			subTeam = new EObjectWithInverseResolvingEList<TeamProfile>(TeamProfile.class, this, UmaPackage.TEAM_PROFILE__SUB_TEAM, UmaPackage.TEAM_PROFILE__SUPER_TEAM);
		}
		return subTeam;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UmaPackage.TEAM_PROFILE__TEAM_ROLES:
				return getTeamRoles();
			case UmaPackage.TEAM_PROFILE__SUPER_TEAM:
				if (resolve) return getSuperTeam();
