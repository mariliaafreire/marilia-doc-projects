 ...
 * <ul>
 *   <li>{@link uma.TeamProfile#getTeamRoles <em>Team Roles</em>}</li>
 *   <li>{@link uma.TeamProfile#getSuperTeam <em>Super Team</em>}</li>
 *   <li>{@link uma.TeamProfile#getSubTeam <em>Sub Team</em>}</li>
 * </ul>
 * </p>
 *
 * @see uma.UmaPackage#getTeamProfile()
 * @model
 * @generated
 */
public interface TeamProfile extends BreakdownElement {
	 ...
	 * @see uma.UmaPackage#getTeamProfile_TeamRoles()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link uma.TeamProfile#getSubTeam <em>Sub Team</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uma.UmaPackage#getTeamProfile_SuperTeam()
	...
	/**
	 * Sets the value of the '{@link uma.TeamProfile#getSuperTeam <em>Super Team</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link uma.TeamProfile}.
	 * It is bidirectional and its opposite is '{@link uma.TeamProfile#getSuperTeam <em>Super Team</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uma.UmaPackage#getTeamProfile_SubTeam()
