...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public ProcessDefinitionType getProcessDefinition() {
		return (ProcessDefinitionType)getMixed().get(Jpdl31Package.Literals.DOCUMENT_ROOT__PROCESS_DEFINITION, true);
	}
	...
	public NotificationChain basicSetProcessDefinition(ProcessDefinitionType newProcessDefinition, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(Jpdl31Package.Literals.DOCUMENT_ROOT__PROCESS_DEFINITION, newProcessDefinition, msgs);
	}
	...
	public void setProcessDefinition(ProcessDefinitionType newProcessDefinition) {
		((FeatureMap.Internal)getMixed()).set(Jpdl31Package.Literals.DOCUMENT_ROOT__PROCESS_DEFINITION, newProcessDefinition);
	}
