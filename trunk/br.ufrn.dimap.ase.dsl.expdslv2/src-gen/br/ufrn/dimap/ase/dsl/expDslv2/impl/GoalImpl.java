...
public class GoalImpl extends MinimalEObjectImpl.Container implements Goal
{
  ...
  {
		return ExpDslv2Package.Literals.GOAL;
	}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDslv2Package.GOAL__NAME, oldName, name));
	}
  ...
  public void setDescription(String newDescription)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpDslv2Package.GOAL__DESCRIPTION, oldDescription, description));
	}
  ...
  {
		switch (featureID) {
			case ExpDslv2Package.GOAL__NAME:
				return getName();
