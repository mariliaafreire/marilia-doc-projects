...
public class ProcessModelPackageImpl extends EPackageImpl implements ProcessModelPackage {
	 ...
	 * @see processModel.ProcessModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getTask_Input() {
	 ...
	 * @generated
	 */
	public EAttribute getActivity_Index() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTask_Input(), ecorePackage.getEString(), "input", null, 0, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		getActivity_Predecessor().getEKeys().add(this.getActivity_Index());
		initEAttribute(getActivity_Index(), ecorePackage.getEInt(), "index", null, 0, 1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(processEClass, processModel.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, processModel.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_Activity(), this.getActivity(), null, "activity", null, 0, -1, processModel.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEAnnotation0Annotations() {
		...
		addAnnotation
		  (this, 
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Activity/task")
		   });
	}
