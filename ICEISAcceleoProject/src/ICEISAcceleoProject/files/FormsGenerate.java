...
/**
 * Entry point of the 'FormsGenerate' generation module.
 *
 * @generated
 */
public class FormsGenerate extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "formsGenerate";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "formsGenerate", };
	 ...
	 * @generated
	 */
	public FormsGenerate(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public FormsGenerate(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				FormsGenerate generator = new FormsGenerate(modelURI, folder, arguments);
