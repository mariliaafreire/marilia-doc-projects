 ...
 * <ul>
 *   <li>{@link jpdl31.JoinType#getNodeContentElements <em>Node Content Elements</em>}</li>
 *   <li>{@link jpdl31.JoinType#getEvent <em>Event</em>}</li>
 *   <li>{@link jpdl31.JoinType#getExceptionHandler <em>Exception Handler</em>}</li>
 *   <li>{@link jpdl31.JoinType#getTimer <em>Timer</em>}</li>
 *   <li>{@link jpdl31.JoinType#getTransition <em>Transition</em>}</li>
 *   <li>{@link jpdl31.JoinType#getAsync <em>Async</em>}</li>
 *   <li>{@link jpdl31.JoinType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see jpdl31.Jpdl31Package#getJoinType()
...
public interface JoinType extends EObject {
	 ...
	 * @see jpdl31.Jpdl31Package#getJoinType_NodeContentElements()
	 ...
	 * @see jpdl31.Jpdl31Package#getJoinType_Event()
	 ...
	 * @see jpdl31.Jpdl31Package#getJoinType_ExceptionHandler()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see jpdl31.Jpdl31Package#getJoinType_Timer()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see jpdl31.Jpdl31Package#getJoinType_Transition()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #unsetAsync()
	 * @see #setAsync(String)
	 * @see jpdl31.Jpdl31Package#getJoinType_Async()
	...
	/**
	 * Sets the value of the '{@link jpdl31.JoinType#getAsync <em>Async</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link jpdl31.JoinType#getAsync <em>Async</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetAsync()
	 * @see #getAsync()
	...
	/**
	 * Returns whether the value of the '{@link jpdl31.JoinType#getAsync <em>Async</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see jpdl31.Jpdl31Package#getJoinType_Name()
	...
	/**
	 * Sets the value of the '{@link jpdl31.JoinType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
